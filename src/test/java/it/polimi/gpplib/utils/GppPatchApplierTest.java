...
public class GppPatchApplierTest {
        ...
        public void testApplyPatch_invalidOp() {
                try {
                        SuggestedGppPatch patch = new SuggestedGppPatch("testPatch", Collections.emptyList(), null,
                                        Constants.PATH_PROCUREMENT_PROJECT, "<value>potato</value>", "potato",
                                        "Test patch", "LOT-0001");
        ...
        public void testApplyPatch_invalidLotID() {
                try {
                        SuggestedGppPatch patch = new SuggestedGppPatch("testPatch", Collections.emptyList(), null,
                                        Constants.PATH_PROCUREMENT_PROJECT, "<value>potato</value>", "create",
                                        "Test patch", "LOT-0009");
                        patchApplier.applyPatch(notice, patch);
                        fail("Expected IllegalArgumentException");
                } catch (IllegalArgumentException ex) {
        ...
        public void testApplyPatch_invalidValue() {
                try {
                        SuggestedGppPatch patch = new SuggestedGppPatch("testPatch", Collections.emptyList(), null,
                                        Constants.PATH_PROCUREMENT_PROJECT, "<hola....", "create", "Test patch",
                                        "LOT-0001");
                        patchApplier.applyPatch(notice, patch);
                        fail("Expected IllegalArgumentException");
                } catch (IllegalArgumentException ex) {
        ...
        public void testApplyPatch_successfulPatch() {
                SuggestedGppPatch patch = new SuggestedGppPatch("testPatch", Collections.emptyList(), null,
                                Constants.PATH_PROCUREMENT_PROJECT, "<value>potato</value>", "create", "Test patch",
                                "LOT-0001");
        ...
        public void testApplyPatch_procurementProjectWithSchemaOrdering() {
                ...
                String insertedValue = XmlUtils.getNodeValueAtPath(lot,
                                Constants.PATH_PROCUREMENT_PROJECT
        ...
        public void testApplyPatch_elementNotInSchema() {
                ...
                // Verify the element was inserted
                Node insertedNode = XmlUtils.getNodeAtPath(lot,
                                Constants.PATH_PROCUREMENT_PROJECT + "/NonSchemaElement");
        ...
        public void testApplyPatch_elementIsLastInSchema() {
                ...
                SuggestedGppPatch patch = new SuggestedGppPatch("lastElementPatch", Collections.emptyList(), null,
                                Constants.PATH_PROCUREMENT_PROJECT, patchValue, "create", "Last Element Patch",
                                "LOT-0001");
        ...
        public void testApplyPatch_multipleProcurementProjectElements() {
                ...
                SuggestedGppPatch firstPatch = new SuggestedGppPatch("gppPatch1", Collections.emptyList(), null,
                                Constants.PATH_PROCUREMENT_PROJECT, firstPatchValue, "create", "First GPP Patch",
                                "LOT-0001");

                SuggestedGppPatch secondPatch = new SuggestedGppPatch("gppPatch2", Collections.emptyList(), null,
                                Constants.PATH_PROCUREMENT_PROJECT, secondPatchValue, "create", "Second GPP Patch",
                                "LOT-0001");
                ...
                Node secondInserted = XmlUtils.getNodeAtPath(lot,
                                Constants.PATH_PROCUREMENT_PROJECT + "/cac:Description");
        ...
        public void testApplyPatch_schemaOrderingVerification() {
                ...
                SuggestedGppPatch patch = new SuggestedGppPatch("earlyPatch", Collections.emptyList(), null,
                                Constants.PATH_PROCUREMENT_PROJECT, earlyElementPatch, "create", "Early Element Patch",
                                "LOT-0001");
                ...
                for (int i = 0; i < procurementProject.getChildNodes().getLength(); i++) {
                        ...
                        if (child.getNodeType() == Node.ELEMENT_NODE) {
                                ...
                                if ("cbc:ID".equals(nodeName)) {
                                        foundId = true;
                                        assertFalse("ID should come before MainCommodityClassification",
                                                        foundMainClassification);
        ...
        public void testApplyPatch_updateOperation() {
                ...
                SuggestedGppPatch setupPatch = new SuggestedGppPatch("setupPatch", Collections.emptyList(), null,
                                Constants.PATH_PROCUREMENT_PROJECT, tenderingTermsValue, "create", "Setup patch",
                                "LOT-0001");
                ...
                SuggestedGppPatch updatePatch = new SuggestedGppPatch("updatePatch", Collections.emptyList(), null,
                                updatePath, updatedAwardCriterion, "update",
                                "Update award criterion with GPP structure", "LOT-0001");
        ...
        public void testApplyPatch_updateOperation_invalidXmlValue() {
                ...
                try {
                        ...
                        assertTrue("Should mention invalid patch value",
                                        ex.getMessage().contains("Invalid patch value"));
                }
        }
        ...
        public void testApplyPatch_updateOperation_withComplexPath() {
                ...
                SuggestedGppPatch setupPatch = new SuggestedGppPatch("setupPatch", Collections.emptyList(), null,
                                Constants.PATH_PROCUREMENT_PROJECT, complexStructure, "create", "Setup patch",
                                "LOT-0001");
                notice = patchApplier.applyPatch(notice, setupPatch);
                ...
                SuggestedGppPatch updatePatch = new SuggestedGppPatch("updatePatch", Collections.emptyList(), null,
                                complexUpdatePath, updatedQualityCriterion, "update", "Update quality criterion",
                                "LOT-0001");
                ...
                String updatedDescription = XmlUtils.getNodeValueAtPath(updatedLot,
                                complexUpdatePath + "/cbc:Description");
        ...
        @Test
        public void testUpdateAwardCriteriaWeights() {
                // Create a test notice with existing award criteria
                String existingCriteriaXml = "<cac:TenderingTerms xmlns:cac=\"urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2\" xmlns:cbc=\"urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2\" xmlns:ext=\"urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2\" xmlns:efext=\"http://data.europa.eu/p27/eforms-ubl-extensions/1\" xmlns:efac=\"http://data.europa.eu/p27/eforms-ubl-extension-aggregate-components/1\" xmlns:efbc=\"http://data.europa.eu/p27/eforms-ubl-extension-basic-components/1\">"
                                + "<cac:AwardingTerms>"
                                + "<cac:AwardingCriterion>"
                                + "<cac:SubordinateAwardingCriterion>"
                                + "<ext:UBLExtensions>"
                                ...
                                + "<cbc:Name languageID=\"EN\">Price Criterion</cbc:Name>"
                                + "<cbc:Description languageID=\"EN\">Price evaluation</cbc:Description>"
                                + "</cac:SubordinateAwardingCriterion>"
                                + "<cac:SubordinateAwardingCriterion>"
                                + "<ext:UBLExtensions>"
                                + "<ext:UBLExtension>"
                                ...
                                + "<cbc:AwardingCriterionTypeCode listName=\"award-criterion-type\">quality</cbc:AwardingCriterionTypeCode>"
                                + "<cbc:Name languageID=\"EN\">Quality Criterion</cbc:Name>"
                                + "<cbc:Description languageID=\"EN\">Quality evaluation</cbc:Description>"
                                + "</cac:SubordinateAwardingCriterion>"
                                + "</cac:AwardingCriterion>"
                                + "</cac:AwardingTerms>"
                                + "</cac:TenderingTerms>";

                // Apply the existing criteria structure
                SuggestedGppPatch setupPatch = new SuggestedGppPatch("setupPatch", Collections.emptyList(), null,
                                "cac:TenderingTerms", existingCriteriaXml, "update", "Setup existing criteria",
                                "LOT-0001");
                Notice originalNotice = patchApplier.applyPatch(notice, setupPatch);

                // Now add new GPP criteria with placeholder weights
                String newGppCriterion1 = "<cac:SubordinateAwardingCriterion xmlns:cac=\"urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2\" xmlns:cbc=\"urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2\" xmlns:ext=\"urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2\" xmlns:efext=\"http://data.europa.eu/p27/eforms-ubl-extensions/1\" xmlns:efac=\"http://data.europa.eu/p27/eforms-ubl-extension-aggregate-components/1\" xmlns:efbc=\"http://data.europa.eu/p27/eforms-ubl-extension-basic-components/1\">"
                                + "<ext:UBLExtensions>"
                                + "<ext:UBLExtension>"
                                + "<ext:ExtensionContent>"
                                + "<efext:EformsExtension>"
                                + "<efac:AwardCriterionParameter>"
                                + "<efbc:ParameterCode listName=\"number-weight\">per-exa</efbc:ParameterCode>"
                                + "<efbc:ParameterNumeric>" + Constants.PLACEHOLDER_WEIGHT + "</efbc:ParameterNumeric>"
                                + "</efac:AwardCriterionParameter>"
                                + "</efext:EformsExtension>"
                                + "</ext:ExtensionContent>"
                                + "</ext:UBLExtension>"
                                + "</ext:UBLExtensions>"
                                + "<cbc:AwardingCriterionTypeCode listName=\"award-criterion-type\">quality</cbc:AwardingCriterionTypeCode>"
                                + "<cbc:Name languageID=\"EN\">GPP Environmental Criterion 1</cbc:Name>"
                                + "<cbc:Description languageID=\"EN\">Environmental impact assessment</cbc:Description>"
                                + "</cac:SubordinateAwardingCriterion>";

                String newGppCriterion2 = "<cac:SubordinateAwardingCriterion xmlns:cac=\"urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2\" xmlns:cbc=\"urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2\" xmlns:ext=\"urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2\" xmlns:efext=\"http://data.europa.eu/p27/eforms-ubl-extensions/1\" xmlns:efac=\"http://data.europa.eu/p27/eforms-ubl-extension-aggregate-components/1\" xmlns:efbc=\"http://data.europa.eu/p27/eforms-ubl-extension-basic-components/1\">"
                                + "<ext:UBLExtensions>"
                                + "<ext:UBLExtension>"
                                + "<ext:ExtensionContent>"
                                + "<efext:EformsExtension>"
                                ...
                                + "</ext:UBLExtensions>"
                                + "<cbc:AwardingCriterionTypeCode listName=\"award-criterion-type\">quality</cbc:AwardingCriterionTypeCode>"
                                + "<cbc:Name languageID=\"EN\">GPP Environmental Criterion 2</cbc:Name>"
                                + "<cbc:Description languageID=\"EN\">Energy efficiency requirements</cbc:Description>"
                                + "</cac:SubordinateAwardingCriterion>";

                // Add the new GPP criteria to the patched notice
                Notice patchedNotice = new Notice(originalNotice.toXmlString());

                SuggestedGppPatch gppPatch1 = new SuggestedGppPatch("gppPatch1", Collections.emptyList(), null,
                                "cac:TenderingTerms/cac:AwardingTerms/cac:AwardingCriterion",
                                newGppCriterion1, "create", "Add GPP Criterion 1", "LOT-0001");
                patchedNotice = patchApplier.applyPatch(patchedNotice, gppPatch1);

                SuggestedGppPatch gppPatch2 = new SuggestedGppPatch("gppPatch2", Collections.emptyList(), null,
                                "cac:TenderingTerms/cac:AwardingTerms/cac:AwardingCriterion",
                                newGppCriterion2, "create", "Add GPP Criterion 2", "LOT-0001");
                patchedNotice = patchApplier.applyPatch(patchedNotice, gppPatch2);

                // Update existing criteria to have placeholder weights
                String updatedPriceCriterion = "<cac:SubordinateAwardingCriterion xmlns:cac=\"urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2\" xmlns:cbc=\"urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2\" xmlns:ext=\"urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2\" xmlns:efext=\"http://data.europa.eu/p27/eforms-ubl-extensions/1\" xmlns:efac=\"http://data.europa.eu/p27/eforms-ubl-extension-aggregate-components/1\" xmlns:efbc=\"http://data.europa.eu/p27/eforms-ubl-extension-basic-components/1\">"
                                + "<ext:UBLExtensions>"
                                + "<ext:UBLExtension>"
                                + "<ext:ExtensionContent>"
                                + "<efext:EformsExtension>"
                                ...
                                + "<cbc:AwardingCriterionTypeCode listName=\"award-criterion-type\">price</cbc:AwardingCriterionTypeCode>"
                                + "<cbc:Name languageID=\"EN\">Price Criterion</cbc:Name>"
                                + "<cbc:Description languageID=\"EN\">Price evaluation with GPP considerations</cbc:Description>"
                                + "</cac:SubordinateAwardingCriterion>";

                String updatedQualityCriterion = "<cac:SubordinateAwardingCriterion xmlns:cac=\"urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2\" xmlns:cbc=\"urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2\" xmlns:ext=\"urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2\" xmlns:efext=\"http://data.europa.eu/p27/eforms-ubl-extensions/1\" xmlns:efac=\"http://data.europa.eu/p27/eforms-ubl-extension-aggregate-components/1\" xmlns:efbc=\"http://data.europa.eu/p27/eforms-ubl-extension-basic-components/1\">"
                                + "<ext:UBLExtensions>"
                                + "<ext:UBLExtension>"
                                + "<ext:ExtensionContent>"
                                + "<efext:EformsExtension>"
                                ...
                                + "<cbc:AwardingCriterionTypeCode listName=\"award-criterion-type\">quality</cbc:AwardingCriterionTypeCode>"
                                + "<cbc:Name languageID=\"EN\">Quality Criterion</cbc:Name>"
                                + "<cbc:Description languageID=\"EN\">Quality evaluation with GPP considerations</cbc:Description>"
                                + "</cac:SubordinateAwardingCriterion>";

                // Update existing criteria to have placeholder weights
                SuggestedGppPatch updatePricePatch = new SuggestedGppPatch("updatePricePatch", Collections.emptyList(),
                                null,
                                "cac:TenderingTerms/cac:AwardingTerms/cac:AwardingCriterion/cac:SubordinateAwardingCriterion[cbc:Name='Price Criterion']",
                                updatedPriceCriterion, "update", "Update Price Criterion", "LOT-0001");
                patchedNotice = patchApplier.applyPatch(patchedNotice, updatePricePatch);

                SuggestedGppPatch updateQualityPatch = new SuggestedGppPatch("updateQualityPatch",
                                Collections.emptyList(), null,
                                "cac:TenderingTerms/cac:AwardingTerms/cac:AwardingCriterion/cac:SubordinateAwardingCriterion[cbc:Name='Quality Criterion']",
                                updatedQualityCriterion, "update", "Update Quality Criterion", "LOT-0001");
                patchedNotice = patchApplier.applyPatch(patchedNotice, updateQualityPatch);

                // Now call the weight update function
                patchApplier.updateAwardCriteriaWeights(patchedNotice, originalNotice);

                // Verify the weights have been updated correctly
                Node lot = patchedNotice.getLotNode("LOT-0001");
                assertNotNull("Lot should exist", lot);

                // Get all award criteria nodes
                org.w3c.dom.NodeList criteriaNodes = XmlUtils.getNodesAtPath(lot, Constants.PATH_AWARD_CRITERION);
                assertEquals("Should have 4 award criteria", 4, criteriaNodes.getLength());

                // Collect and verify weights
                int totalWeight = 0;
                int newCriteriaWeight = 0;
                int existingCriteriaWeight = 0;

                for (int i = 0; i < criteriaNodes.getLength(); i++) {
                        Node criterion = criteriaNodes.item(i);
                        String name = XmlUtils.getNodeValueAtPath(criterion, Constants.PATH_IN_AWARD_CRITERION_NAME);
                        String weightStr = XmlUtils.getNodeValueAtPath(criterion,
                                        Constants.PATH_IN_AWARD_CRITERION_WEIGHT);
                        int weight = Integer.parseInt(weightStr);

                        totalWeight += weight;

                        if (name.contains("GPP Environmental")) {
                                newCriteriaWeight += weight;
                        } else {
                                existingCriteriaWeight += weight;
                        }

                        // Verify no placeholder weights remain
                        assertNotEquals("Weight should not be placeholder", Constants.PLACEHOLDER_WEIGHT, weightStr);
                ...
                // Verify new criteria have DEFAULT_WEIGHT_GPP_CRITERIA total weight
                assertEquals("New criteria should have total weight of " + Constants.DEFAULT_WEIGHT_GPP_CRITERIA,
                                Constants.DEFAULT_WEIGHT_GPP_CRITERIA, newCriteriaWeight);

                // Verify existing criteria have remaining weight
                assertEquals("Existing criteria should have remaining weight",
                                100 - Constants.DEFAULT_WEIGHT_GPP_CRITERIA, existingCriteriaWeight);

                // Verify proportional distribution among existing criteria
                // Original weights were 60 and 40, so new weights should be proportional
                String priceWeight = XmlUtils.getNodeValueAtPath(lot,
                                Constants.PATH_AWARD_CRITERION + "[cbc:Name='Price Criterion']/"
                                                + Constants.PATH_IN_AWARD_CRITERION_WEIGHT);
                String qualityWeight = XmlUtils.getNodeValueAtPath(lot,
                                Constants.PATH_AWARD_CRITERION + "[cbc:Name='Quality Criterion']/"
                                                + Constants.PATH_IN_AWARD_CRITERION_WEIGHT);

                int priceWeightInt = Integer.parseInt(priceWeight);
                int qualityWeightInt = Integer.parseInt(qualityWeight);

                // Price should be higher than quality (was 60 vs 40 originally)
                assertTrue("Price weight should be higher than quality weight", priceWeightInt > qualityWeightInt);

                // Check approximate proportionality (allowing for rounding)
                double expectedRatio = 60.0 / 40.0; // 1.5
                double actualRatio = (double) priceWeightInt / qualityWeightInt;
                assertTrue("Weights should maintain approximate proportionality",
                                Math.abs(actualRatio - expectedRatio) < 0.5);
        }

        @Test
        public void testUpdateAwardCriteriaWeights_debug() {
                // Create a test notice with existing award criteria
                String existingCriteriaXml = "<cac:TenderingTerms xmlns:cac=\"urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2\" xmlns:cbc=\"urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2\" xmlns:ext=\"urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2\" xmlns:efext=\"http://data.europa.eu/p27/eforms-ubl-extensions/1\" xmlns:efac=\"http://data.europa.eu/p27/eforms-ubl-extension-aggregate-components/1\" xmlns:efbc=\"http://data.europa.eu/p27/eforms-ubl-extension-basic-components/1\">"
                                + "<cac:AwardingTerms>"
                                + "<cac:AwardingCriterion>"
                ...
                // Apply the existing criteria structure - this should replace the empty
                // TenderingTerms
                SuggestedGppPatch setupPatch = new SuggestedGppPatch("setupPatch", Collections.emptyList(), null,
                                "cac:TenderingTerms", existingCriteriaXml, "update", "Setup existing criteria",
                                "LOT-0001");
                ...
                // Debug: Print the original notice structure
                System.out.println("Original notice after setup:");
                System.out.println(originalNotice.toXmlString());

                // Verify we have the criteria
                Node lot = originalNotice.getLotNode("LOT-0001");
                assertNotNull("Lot should exist", lot);

                org.w3c.dom.NodeList criteriaNodes = XmlUtils.getNodesAtPath(lot, Constants.PATH_AWARD_CRITERION);
                System.out.println("Found " + criteriaNodes.getLength() + " criteria in original notice");

                assertEquals("Should have 1 award criterion after setup", 1, criteriaNodes.getLength());
        }
}